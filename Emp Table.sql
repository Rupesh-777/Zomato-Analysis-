...
insert into emp values (7839, "KING", "PRESIDENT", null, "1981-09-08", 5000.00, null, 10);
...
use emp_dept;
alter  table emp 
ADD column sal_Grade varchar(10)  after deptno;

alter table emp 
drop column sal_grade;

alter  table emp 
ADD column sal_Grade varchar(10);
update emp 
set sal_grade =
case 
